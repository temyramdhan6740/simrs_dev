...
class Dokter extends CI_Controller
{
    ...
    public function create() 
    {
	    ...
	    'kode_dokter' => set_value('kode_dokter','SIMRS_DOK_'.rand(10000,99999)),
    ...
    {
		$filename = "TBL_DOKTER/".date('Y/m/d').".xls";
        ...
        header("Content-Disposition: attachment;Filename=TBL_DOKTER/" . $filename . ".xls");
