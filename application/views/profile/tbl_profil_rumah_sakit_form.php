        ...
        <div class="box box-warning box-solid">
            ...
            <form enctype="multipart/form-data" action="<?php echo $action; ?>" method="post">
                ...
                <table class='table table-bordered'>     
                    ...
                    <tr><td width='200'>Format No Rekamedis <?php echo form_error('format_no_rekamedis') ?></td><td><input type="text" class="form-control" name="format_no_rekamedis" id="format_no_rekamedis" placeholder="Format No Rekamedis" value="<?php echo $format_no_rekamedis; ?>" /></td></tr>
